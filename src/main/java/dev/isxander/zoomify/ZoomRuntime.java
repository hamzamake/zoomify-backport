...
public final class ZoomRuntime {
    ...
    private static final ZoomHelper ZOOM_HELPER = new ZoomHelper(
        ...
        ZoomRuntime::getScrollInterpolationRange
    );
    ...
    public static void onConfigReload() {
        scrollSteps = clampScrollSteps(scrollSteps);
    }
    ...
    private static int getMaxScrollInTiers() {
        return ZoomifyConfig.scrollStepCount;
    }

    private static int getMaxScrollOutTiers() {
        return ZoomifyConfig.scrollStepCountOut;
    }

    private static int getScrollInterpolationRange() {
        return Math.max(getMaxScrollInTiers(), getMaxScrollOutTiers());
    }

    private static int clampScrollSteps(int steps) {
        return Math.max(-getMaxScrollOutTiers(), Math.min(steps, getMaxScrollInTiers()));
    }
