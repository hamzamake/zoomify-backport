...
public final class ZoomifyConfig {
    ...
    public static int scrollStepCount = 2;
    public static int scrollStepCountOut = 2;
    ...
    public static void sync() {
        ...
        scrollStepCount = configuration.getInt(
            ...
            0,
            200,
            "Maximum number of scroll zoom-in tiers."
        );

        scrollStepCountOut = configuration.getInt(
            "scrollStepCountOut",
            CATEGORY_SCROLL,
            scrollStepCountOut,
            0,
            200,
            "Maximum number of scroll zoom-out tiers."
        );
